namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAverageTicketPriceProcessUsrYacht1MethodsWrapper

	/// <exclude/>
	public class UsrCalcAverageTicketPriceProcessUsrYacht1MethodsWrapper : ProcessModel
	{

		public UsrCalcAverageTicketPriceProcessUsrYacht1MethodsWrapper(Process process)
			: base(process) {
